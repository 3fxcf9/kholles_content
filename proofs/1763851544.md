...
Montrer que si A et B sont deux parties non vides majorées de $\mathbb{R}$, alors sup(A+B) = supA + supB.

---

**Montrer que si $A$ et $B$ sont deux parties non vides majorées de $\mathbb{R}$, alors $\sup(A+B) = \sup A + \sup B$**
